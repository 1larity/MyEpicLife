...
import com.digitale.myepiclife.MyEpicLife;
	...
	public class TestScreen extends MyEpicLifeScreen {
		...
		public TestScreen() {
			skin =MyEpicLife.uiSkin;
			texture1 = new Texture(Gdx.files.internal("data/digitale.png"));
			texture2 = new Texture(Gdx.files.internal("data/digitale.png"));
			...
			Button buttonMulti = new TextButton("Multi Line\nToggle", skin, "toggle");
